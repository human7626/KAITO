...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ K𝐀𝐈 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ K𝐀𝐈 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ K𝐀𝐈 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
{{text = '📂┇𝙳𝚁𝙰𝙶𝙾𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/vaavvvv"}},
}
...
℘ ⦑ SOURCE KAITO ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/vaavvvv)
℘︙ [Source Update ](t.me/vaavvvv)     
℘︙ [Source developer](t.me/TTITITl)     
℘︙ [Dragon programmer](t.me/T_TIMO) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'vaavvvv')..')'
status  = '\n ℘︙ تم تنزيله من المميزين'
texts = usertext..status
else
texts = ' ℘︙ لا يوجد حساب بهاذا المعرف'
...
usertext = '\n ℘︙  المستخدم » ['..result.title_..'](t.me/'..(username or 'vaavvvv')..')'
status  = '\n ℘︙ تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
local blakrt = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ℘︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'vaavvvv')..')'..'\n ℘︙ تم تنريله من '..text1[2]..'')   
database:srem(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
{
{text = 'IMO 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/vaavvvv"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ K𝐀𝐈 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽. ](t.me/vaavvvv)➤ ')
end
